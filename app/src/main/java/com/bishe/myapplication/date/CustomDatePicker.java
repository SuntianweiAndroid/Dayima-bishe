package com.bishe.myapplication.date;
...
public class CustomDatePicker implements View.OnClickListener, PickerView.OnSelectListener {
     ...
     */
    public CustomDatePicker(Context context, Callback callback, long beginTimestamp, long endTimestamp, PickerView mDpvYear, PickerView mDpvMonth, PickerView mDpvDay, PickerView mDpvHour, PickerView mDpvMinute, TextView mTvHourUnit, TextView mTvMinuteUnit) {
        ...
        this.mTvHourUnit = mTvHourUnit;
        this.mTvMinuteUnit = mTvMinuteUnit;

        this.mDpvYear = mDpvYear;
        mDpvYear.setOnSelectListener(this);
        this.mDpvMonth = mDpvMonth;
        mDpvMonth.setOnSelectListener(this);
        this.mDpvDay = mDpvDay;
        mDpvDay.setOnSelectListener(this);
        this.mDpvHour = mDpvHour;
        mDpvHour.setOnSelectListener(this);
        this.mDpvMinute = mDpvMinute;
    ...
    public void show2(String dateStr) {
        ...
        // 弹窗时，考虑用户体验，不展示滚动动画
        setSelectedTime2(DateFormatUtils.str2Long(dateStr, mCanShowPreciseTime), false);
    }
     ...
     * @return 是否设置成功
     */
    public boolean setSelectedTime2(long timestamp, boolean showAnim) {
     ...
     * 设置日期控件是否显示时和分
     */
    public void setCanShowPreciseTime2(boolean canShowPreciseTime) {
        if (canShowPreciseTime) {
            initScrollUnit();
            mDpvHour.setVisibility(View.VISIBLE);
            mTvHourUnit.setVisibility(View.VISIBLE);
     ...
     * 设置日期控件是否可以循环滚动
     */
    public void setScrollLoop2(boolean canLoop) {
        mDpvYear.setCanScrollLoop(canLoop);
        mDpvMonth.setCanScrollLoop(canLoop);
        mDpvDay.setCanScrollLoop(canLoop);
        mDpvHour.setCanScrollLoop(canLoop);
     ...
     * 设置日期控件是否展示滚动动画
     */
    public void setCanShowAnim2(boolean canShowAnim) {
        mDpvYear.setCanShowAnim(canShowAnim);
        mDpvMonth.setCanShowAnim(canShowAnim);
        mDpvDay.setCanShowAnim(canShowAnim);
        mDpvHour.setCanShowAnim(canShowAnim);
