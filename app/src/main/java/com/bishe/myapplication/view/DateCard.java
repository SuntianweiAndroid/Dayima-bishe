 ...
 *
 */
public class DateCard extends LinearLayout{
	//颜色
	...
	private void initView(){
		...
		iv.setImageResource(R.mipmap.dym_nian_r);
	...
	public void setStart(int isStart){
		if(isStart == 1){
			iv.setVisibility(View.VISIBLE);
			iv.setImageResource(R.mipmap.dym_kaishi);
		}else if (isStart == 2) {
			iv.setVisibility(View.VISIBLE);
			iv.setImageResource(R.mipmap.dym_jieshu);
		}else {
			iv.setVisibility(View.GONE);
		}
	}
